...
- Name: security.spec.ts >> SaaS Security & Tenant Isolation Protocols >> Client-Side Injection Prevention (XSS) >> Prototype iFrame should sandbox execution context
- Location: tests\e2e\security.spec.ts:64:9
