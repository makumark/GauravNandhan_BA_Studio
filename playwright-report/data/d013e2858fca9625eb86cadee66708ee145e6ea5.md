...
- Name: core-flow.spec.ts >> Gaurav Nandhan BA Studio - Core Flow >> should load landing page and show greeting
- Location: tests\e2e\core-flow.spec.ts:4:7
...
Locator: locator('h1')
Expected substring: "Gaurav Nandhan"
Error: strict mode violation: locator('h1') resolved to 2 elements:
    1) <h1 class="font-bold text-xl tracking-tight bg-gradient-to-r from-white via-blue-100 to-blue-200 bg-clip-text text-transparent">Gaurav Nandhan</h1> aka getByRole('heading', { name: 'Gaurav Nandhan' })
    2) <h1>Gaurav Nandhan</h1> aka locator('#bulk-print-container').getByText('Gaurav Nandhan')
